	...
	<div class="row">
        <div class="col-xl-4 order-xl-2 mb-5 mb-xl-0">
            <div class="card text-center ">
                <i style="{{ !is_null($perusahaan->logo) ? 'display: none' : '' }}" class="fas fa-user fa-10x pt-5 pb-5"></i>
...
@endsection
@section('stylesheet')
<link rel="stylesheet" href="{{ asset('/admin-template/sweetalert2/dist/sweetalert2.css') }}">
@endsection()
